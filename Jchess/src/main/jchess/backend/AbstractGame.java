...
import jchess.backend.moves.AbstractMove;
import jchess.backend.moves.StandardMove;
...
public abstract class AbstractGame {
    ...
    abstract public AbstractField getField(int[] globalCoords);
    abstract public void endGame(String str);
    abstract public boolean validCoordinates(int[] globalCoords);
    ...
    public void getHighlightedFields(ArrayList<int[]> coordList, 
