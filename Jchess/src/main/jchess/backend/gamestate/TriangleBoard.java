...
public class TriangleBoard extends AbstractBoard{
    ...
    public TriangleBoard(int boardIdx, int dim, AbstractGame game){
        ...
        for(int row=0;row<dim;row++){
            ...
            triangles.add(new Triangle(boardIdx,row,0,firstZ,null));
            ...
            for(int sq =1;sq<=squares;sq++){
                ...
                int rightY =  sq;
                int sqZ = firstZ-sq;
                triangles.add(new Triangle(boardIdx,row,leftY,sqZ,null));
                triangles.add(new Triangle(boardIdx,row,rightY,sqZ,null));
            }
        }
    ...
    private Triangle getTriangle(int x, int y, int z){
        ...
        int firstZ = triangles.get(triIndx).coords[2];
