    ...
    */
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (target == this.okButton) //if clicked OK button (on finish)
        {
            ...
            Game newGame = JChessApp.jcv.addNewTab(this.firstName.getText() + " vs " + this.secondName.getText());
            Settings sett = newGame.settings;//sett local settings variable
            ...
            newGame.chessboard.repaint();
            newGame.chessboard.draw();
        }
