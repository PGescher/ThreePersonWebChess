 ...
 * @param playerID The player color
 */
public class PawnPromotionWindow extends JDialog implements ActionListener
{
    ...
    public PawnPromotionWindow(Frame parent, String color)
    {
        ...
        this.knightButton = new JButton(new ImageIcon(Image_Loader.getImage("Knight-" + color + ".png")));
        this.bishopButton = new JButton(new ImageIcon(Image_Loader.getImage("Bishop-" + color + ".png")));
        this.rookButton = new JButton(new ImageIcon(Image_Loader.getImage("Rook-" + color + ".png")));
        this.queenButton = new JButton(new ImageIcon(Image_Loader.getImage("Queen-" + color + ".png")));
        this.result = "";
    ...
    {
        this.knightButton.setIcon(new ImageIcon(Image_Loader.getImage("Knight-" + color + ".png")));
        this.bishopButton.setIcon(new ImageIcon(Image_Loader.getImage("Bishop-" + color + ".png")));
        this.rookButton.setIcon(new ImageIcon(Image_Loader.getImage("Rook-" + color + ".png")));
        this.queenButton.setIcon(new ImageIcon(Image_Loader.getImage("Queen-" + color + ".png")));
    }
